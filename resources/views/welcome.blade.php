...
<head>
	<meta charset="utf-8" lang='uz' />
	<meta http-equiv="X-UA-Compatible" content="IE=edge" />
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
	<meta name="format-detection" content="telephone=no" />
	<!-- <link rel="shortcut icon" href="https://mift.uz/assets/public/images/favicon.png" />
    <script src="https://use.fontawesome.com/132ea097f3.js"></script>
    <script src="https://use.fontawesome.com/70b876d1cd.js"></script> -->
	<script src="https://use.fontawesome.com/f8e80e47a8.js"></script>
	<link rel="shortcut icon" href="images/logo/logo.png" />
	<title>ГРП</title>

	<!-- <meta property="og:title" content="Ўзбекистон Республикаси Инвестициялар ва ташқи савдо вазирлиги" />
<meta property="og:url" content="https://mift.uz/" />
<meta property="og:type" content="website" />
<meta property='og:image' content='https://mift.uz/assets/public/images/fb.jpg' />
<meta property="og:image:width" content="200" />
<meta property="og:image:height" content="200" />
<meta name="robots" content="index, follow"/> -->
	<!-- <script>
site_url = 'https://mift.uz/uz';
base_url = 'https://mift.uz/';
resource = 'https://mift.uz/assets/public/';
mobile_menu = 'Menyu';
lang = 'uz';
sel = 'home';
</script>     -->
	...
	<link rel="stylesheet" href="js/menu/jquery.mmenu.css" media="screen" />
	<link rel="stylesheet" href="js/menu/sm.css" media="screen" type="text/css" />
	<link rel="stylesheet" href="js/menu/jquery.smartmenus.bootstrap.css" type="text/css">
	<link rel="stylesheet" href="js/menu/jquery.mmenu.css" media="screen" type="text/css" />
	<link rel="stylesheet" type="text/css" href="js/slider-pro/dist/css/slider-pro.min.css" media="screen" />
	<link rel='stylesheet' href='js/stacktable/stacktable.css' type='text/css' media='screen' />
	...
	<!-- <link href="/js/spec/special_view.css?ver=1644913263" rel="stylesheet" /> -->
	...
	<script type="text/javascript" src="js/slider-pro/dist/js/jquery.sliderPro.min.js">
	</script>
	<link rel="stylesheet" type="text/css" href="js/gs/gspeech.css" />
	<link rel="stylesheet" type="text/css" href="js/gs/the-tooltip.css" />
	<!--[if lt IE 9]>
    <link rel="stylesheet" href="https://mift.uz/assets/public/menu/nav/css/ie8-core.min.css">
    <link rel="stylesheet" href="https://mift.uz/assets/public/menu/nav/css/ie8-layout.min.css">
    <script src="https://mift.uz/assets/public/js/html5shiv.min.js"></script>
    <script src="https://mift.uz/assets/public/js/respond.min.js"></script>
<![endif]-->
	<!-- Global site tag (gtag.js) - Google Analytics -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-154353366-1"></script>
	<script>
	...
	gtag('config', 'UA-154353366-1');
	</script>
</head>

<body class="border-menu-home">

	<div class="wrapper is-aside-open">
		<div class="page-wrap-toggle">
				...
				<div class="aside-container">
					<div class="logo">
						<a href="#"><img src="images/logo/logo.png" alt="" />
							<h3>Ўзбекистон Республикаси <br>
								Инвестициялар ва ташқи <br>
								савдо вазирлиги </h3>
					...
					<div class="phones">
						<ul>
							<li><a href="#" style="color: #fff;font-weight:normal;font-size: 14px;"><i
										class="fa fa-phone" aria-hidden="true"></i>Ишонч телефони</a><br><a href="#"
									rel="nofollow">+998 (71) 238-50-05</a></li>
							<li><i class="fa fa-phone" aria-hidden="true"></i>Вазирлик телефони<br><a
									href="tel:+998 (71) 238-50-00" rel="nofollow">+998 (71) 238-50-00</a></li>
							<li><i class="fa fa-phone" aria-hidden="true"></i>Девонхона телефони<br><a
									href="tel:+998 (71)238-50-90 +998 (71) 238-51-90" rel="nofollow">+998 (71) 238-50-90
									+998 (71) 238-51-90</a></li>
							<li class="mail-l"> <i class=" feather feather-mail" aria-hidden="true"></i>Корпоратив
								почта<br><a href="mailto:info@mift.uz <br> mift@exat.uz" rel="nofollow">info@mift.uz
									<br>
									mift@exat.uz</a></li>
							<i class="fa-thin fa-envelope"></i>
							<i src="images/statistics/mail_white.svg" alt=""></i>

						</ul>
					</div>
					<div class="aside-button">
						<a href="#">Хабар жўнатмоқ</a>

					</div>

					<div class="aside-social">
						<h4>Биз ижтимоий тармоқларда</h4>
						<ul>

							<li> <a href="http://facebook.com" target="_blank"><i class="fa fa-facebook"
										aria-hidden="true"></i></a></li>
							<li> <a href="http://instagram.com" target="_blank"><i class="fa fa-instagram"
										aria-hidden="true"></i></a></li>
							<li> <a href="https://t.me" target="_blank"><i class="fa fa-telegram"
										aria-hidden="true"></i></a></li>
		...
		<div class="page-wrap-section">
			<!-- header menu start -->
			<header class="header-block home-header">
				<div class="header-main">
					...
					<div class="header-menu">
						<div class="container">
							<div class="header-logo">
								<a href="#"><img src="images/logo/logo.svg" alt="logo" />
									<h3>Ўзбекистон Республикаси <br>
										Инвестициялар ва ташқи <br>
										савдо вазирлиги </h3>

							</div>
							<a href="javascript:;" class="header-burger js-headerBurgerMenu">
								<i class="fa fa-bars"></i>
								<i class="fa fa-times"></i>
							</a>
							<div class="new-navbar desktop-menu">
								<ul class="nav navbar-nav" id="main-menu">
									<li class="dropdown nav-item"><a data-alias="ministerstvo"
											class="dropdown-toggle  no-link nav-link" href="#">Марказ<i
												class="fa fa-angle-down" aria-hidden="true"></i></a>
										<ul class="dropdown-menu sub-menu">
											<li class="dropdown dropdown-item"><a href="#">Марказ Хакида</a>
											<li class="dropdown dropdown-item"><a href="#">Раҳбарият</a>
											<li class="dropdown dropdown-item"><a href="#">Таркибий тузилма</a>
											<li class="dropdown dropdown-item"><a href="#">Хамкор ХМИ</a>

										</ul>
									<li class="dropdown nav-item"><a data-alias="#"
											class="dropdown-toggle no-link nav-link" href="#">Лойихалар<i
												class="fa fa-angle-down" aria-hidden="true"></i></a>
										<ul class="dropdown-menu sub-menu">

											<li class="dropdown dropdown-item"><a href="#">Амалдаги лойихалар
													<i class="fa fa-chevron-right" aria-hidden="true"></i></a>
												<ul class="dropdown-menu sub-menu">
													<li class="dropdown dropdown-item"><a href="#"><i
																class="fa fa-chevron-right" aria-hidden="true"></i></a>
														<ul class="dropdown-menu sub-menu">
															<li class="dropdown dropdown-item"><a href="#">1.1</a>
															<li class="dropdown dropdown-item"><a href="#">1.2</a>
														</ul>

												</ul>
											<li class="dropdown dropdown-item"><a href="#">Истикболдаги лойихалар
													<i class="fa fa-chevron-right" aria-hidden="true"></i></a>
												<ul class="dropdown-menu sub-menu">
													<li class="dropdown dropdown-item"><a href="#"><i
																class="fa fa-chevron-right" aria-hidden="true"></i></a>
														<ul class="dropdown-menu sub-menu">
															<li class="dropdown dropdown-item"><a href="#">2.1</a>
															<li class="dropdown dropdown-item"><a href="#">2.2</a>
														</ul>

												</ul>
										</ul>
									<li class="dropdown nav-item"><a data-alias="vneshnjaja-torgovlja"
											class="dropdown-toggle  no-link nav-link" href="#a">Тендер<i
												class="fa fa-angle-down" aria-hidden="true"></i></a>
										<ul class="dropdown-menu sub-menu">
											<li class="dropdown-item dropdown-submenu"><a class="dropdown-toggle"
													href="#">Тендер таргинлари</a>
											<li class="dropdown-item dropdown-submenu"><a class="dropdown-toggle"
													href="#">2</a>
											<li class="dropdown-item dropdown-submenu"><a class="dropdown-toggle"
													href="#">3</a>
									...
									<li class="dropdown nav-item"><a data-alias="vneshnjaja-torgovlja"
											class="dropdown-toggle  no-link nav-link" href="#a">Алока<i
												class="fa fa-angle-down" aria-hidden="true"></i></a>
										<ul class="dropdown-menu sub-menu">
											<li class="dropdown-item dropdown-submenu"><a class="dropdown-toggle"
													href="#">Харита</a>
								...
								<div id="dl-menu">
									<span class="social-mobile social">
										<ul class="list-unstyled">
											<li> <a href="#" target="_blank"><i class="icons icon-facebook"
														aria-hidden="true"></i></a></li>
											<li> <a href="#" target="_blank"><i class="icons icon-instagram"
														aria-hidden="true"></i></a></li>
											<li> <a href="#" target="_blank"><i class="icons icon-telegram"
														aria-hidden="true"></i></a></li>
											<li> <a href="#z" target="_blank"><i class="fa fa-twitter"
														aria-hidden="true"></i></a></li>
										</ul>
									</span>
									<span class="language-mobile">
										<a href="#" class="item">Русский</a>
										<a href="#" class="item">Ўзбекча</a>
									...
									<button class="dl-trigger"><i class="fa fa-bars" aria-hidden="true"></i> <i
											class="fa fa-times" aria-hidden="true"></i> Menyu</button>
									<ul id="main-menu">
										<li class="nav-submenu"><a data-alias="ministerstvo" class="nav-link no-link"
												href="https://mift.uz/uz/menu/ministerstvo">Вазирлик</a>
											<ul>
												<li class=""><a href="https://mift.uz/uz/menu/o-ministerstve">Вазирлик
														ҳақида</a>
												<li class=""><a href="#">Раҳбарият</a>
												<li class=""><a href="#">Таркибий тузилма</a>
												<li class=""><a href="#">Вазирликда ишлаш</a>
												<li class=""><a href="#">Қуйи
														ташкилотлар</a>
												<li class=""><a href="#">Mintaqadagi
														vakillar</a>
												<li class=""><a href="#">Худудларга
														бириктирилган</a>
												<li class=""><a href="#">Хорижий
														вакиллар</a>
												<li class=""><a href="#">Очиқ маълумотлар</a>
												<li class=""><a href="#">Вазирлик
														хизматлари</a>
												<li class=""><a href="#">Ўзбекистон
														Республикасининг МДҲдаги иштироки</a>
												<li class=""><a href="#">Ёшлар
														Кенгаши</a>
												<li class=""><a href="#">Маънавият
														ва давлат тили масалалари</a>
												<li class="nav-submenu"><a href="#">Вазирлик
														харажатлари моддалари</a>
													<ul>
														<li class="nav-submenu"><a href="#">Очиқ
																маълумотлар</a>
															<ul>
																<li class=""><a href="#">2021</a>
															</ul>
													</ul>
												<li class=""><a href="#">Коррупцияга
														қарши кураш</a>
											</ul>
										<li class="nav-submenu"><a data-alias="zakonodatelstvo" class="nav-link no-link"
												href="#">Қонунчилик</a>
											<ul>
												<li class="nav-submenu"><a href="#">Ташқи
														иқтисодий ва вазирлик фаолиятининг ҳуқуқий асослари</a>
													<ul>
														<li class=""><a href="#">ВМҚ-355
																талаблари</a>
													</ul>
												<li class=""><a href="#">Вазирликнинг
														идоравий хужжатлари</a>
												<li class=""><a href="#">Инвестициявий
														бошқарув</a>
												<li class=""><a href="#">Ташқи
														савдо бошқаруви</a>
												<li class=""><a href="#">Транспорт
														соҳасида </a>
												<li class=""><a href="#">Божхона
														ва солиқ бошқаруви</a>
												<li class=""><a href="#">Хавфсизлик
														сиёсати</a>
												<li class=""><a href="#">Ўз
														кучини йўқотган меъёрий-ҳуқуқий ҳужжатлар</a>
												<li class=""><a href="#">Ишлаб
														чиқилаётган меъёрий-хуқуқий ҳужжатлар лойиҳалари</a>
											</ul>
										<li class="nav-submenu"><a data-alias="#" class="nav-link no-link"
												href="#">Инвестициялар</a>
											<ul>
												<li class=""><a href="#">Ўзбекистон
														ҳақида</a>
												<li class=""><a href="#">Инвесторлар учун
														қўлланма</a>
												<li class=""><a href="#">Инвесторлар
														муваффақияти тарихи</a>
												<li class=""><a href="#">Хорижий
														инвесторлар кенгаши</a>
												<li class=""><a href="#">Статистика ва
														таҳлил</a>
												<li class="nav-submenu"><a href="#">Инвестиция
														муҳити</a>
													<ul>
														<li class="nav-submenu"><a href="#">Жаҳон
																банкининг кредитлари иштирокида «Ўрта шаҳарларни
																комплекс ривожлантириш» лойиҳаси</a>
															<ul>
																<li class=""><a href="#">Жаҳон
																		банки кредитлари иштирокида “Ўрта шаҳарларни ҳар
																		томонлама ривожлантириш” лойиҳаси,
																		01.07.2021й.</a>
																<li class=""><a href="#">Жаҳон
																		банки кредитлари иштирокида “Ўрта шаҳарларни
																		комплекс ривожлантириш” лойиҳаси,
																		01.01.2022й.</a>
																<li class=""><a href="#">Жаҳон
																		банки кредитлари иштирокида “Ўрта шаҳарларни
																		комплекс ривожлантириш” лойиҳаси,
																...
																<li class=""><a href="#">Жаҳон
																		банки кредитлари иштирокида “Ўрта шаҳарларни
																		комплекс ривожлантириш” лойиҳаси, 01.10.2021
																		й.</a>
															</ul>
														<li class=""><a href="#">“Роуд-шоу”
																хорижий инвестицияларни жалб этиш воситаси сифатида</a>
														<li class=""><a href="#">Ўзбекистоннинг
																эркин иқтисодий зоналари: 2020 йил якунлари ва 2021
																йилда ривожланиш истиқболлари</a>
														<li class=""><a
																href="https://mift.uz/uz/menu/mery-po-privlecheniju-inostrannyh-investitsij-i-uluchsheniju-investitsionnoj-privlekatelnosti-uzbekistana">Хорижий
																инвестицияларни жалб қилиш ва Ўзбекистоннинг инвестиция
																жозибадорлигини ошириш бўйича чора-тадбирлар</a>
													</ul>
											</ul>
										<li class="nav-submenu"><a data-alias="vneshnjaja-torgovlja"
												class="nav-link no-link"
												href="https://mift.uz/uz/menu/vneshnjaja-torgovlja">Ташқи савдо</a>
											<ul>
												<li class=""><a href="https://mift.uz/uz/menu/transportirovka">Юк
														ташиш</a>
												<li class=""><a
														href="https://mift.uz/uz/menu/transportnye-koridory">Транспорт
														йўлаклари</a>
												<li class=""><a
														href="https://mift.uz/uz/pages/statistika-tovarooborota">Статистика
														ва таҳлил</a>
											</ul>
										<li class="nav-submenu"><a data-alias="press-sluzba" class="nav-link no-link"
												href="https://mift.uz/uz/menu/press-sluzba">Матбуот хизмати</a>
											<ul>
												<li class=""><a href="https://mift.uz/uz/news">Янгиликлар</a>
												<li class=""><a href="https://mift.uz/uz/activity/anons">Анонс</a>
												<li class=""><a href="https://mift.uz/uz/gallery">Медиа</a>
												<li class=""><a
														href="https://mift.uz/uz/menu/porjadok-akkreditatsii">Аккредитация
														тартиби</a>
												<li class=""><a
														href="https://mift.uz/uz/menu/obratnaja-svjaz-s-press-sluzhboj">Матбуот
														хизмати билан алоқа</a>
												<li class=""><a
														href="https://mift.uz/uz/menu/porjadok-rassmotrenija-zaprosov-o-predostavlenii-informatsii">Ахборот
														олиш учун сўровларни кўриб чиқиш тартиби</a>
											</ul>
										<li class=""><a data-alias="contacts" class=" "
												href="https://mift.uz/uz/contacts">Алоқа</a>
										<li class=""><a data-alias="sitemap" class=" "
												href="https://mift.uz/uz/sitemap">Сайт харитаси</a>
									</ul>
								</div>
							</div>
					...
					<div class="header-block-right">
						<div class="header-search js-headerSearch">
							<div class="header-search__control js-headerSearchControl">
								<i class="fa fa-search"></i>
							</div>
							<form action="https://search" accept-charset="utf-8" method="get"
								class="header-search__form">
								<input type="text" placeholder="Излаш" name="word"
									class="header-search__input js-headerSearchInput" autocomplete="off"
					...
					<div class="desktop language">
						...
						<a class="dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown"
							...
							Ўзбекча <i class="fa fa-angle-down" aria-hidden="true"></i>
						</a>
						<ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownMenuButton">
							<li style="display:block"><a href="https://mift.uz/ru" class="item">Русский</a></li>
							<li style="display:none"><a href="https://mift.uz/uz" class="item">Ўзбекча</a></li>
							<li style="display:block"><a href="https://mift.uz/en" class="item">English</a></li>
						</ul>
					</div>
					<!-- <div class="header-volume">
                        <a href="#" data-toggle="modal" data-target="#volume" title="Овозли ўқиш"><i
                                class="fa fa-volume-up" aria-hidden="true"></i></a>
                    </div>
                    <div class="header-eye">
                        <a href="#" class="vi-open" title="Заиф кўрувчилар учун"><i class="icon-reading-eyeglasses"
			...
			<div class="header-menu-block">
				<div class="header-menu__scroll js-headerMenuScroll">
					<div class="header-menu__container">
						<div class="header-menu__nav">
							<div class="header-menu__nav-grid">


								<div class="header-menu__nav-col">


									<div class="header-menu__nav-elem">
										<div class="header-menu__nav-label"><a href=""
												class="header-menu__nav-link">Вазирлик</a>
											<div class="header-menu__nav-toggle js-headerMenuNavToggle">
										...
										<div class="header-menu__nav-list">
											<ul class="list-unstyled">
												<li><a href="https://mift.uz/uz/menu/o-ministerstve">Вазирлик ҳақида</a>
												</li>
												<li><a href="https://mift.uz/uz/manage">Раҳбарият</a></li>
												<li><a href="https://mift.uz/uz/central">Таркибий тузилма</a></li>
												<li><a href="https://mift.uz/uz/vacancy">Вазирликда ишлаш</a></li>
												<li><a href="https://mift.uz/uz/organizations">Қуйи ташкилотлар</a></li>
												<li><a href="https://mift.uz/uz/menu/predstaviteli-v-regionah">Mintaqadagi
														vakillar</a></li>
												<li><a href="https://mift.uz/uz/territory">Худудларга бириктирилган</a>
												</li>
												<li><a href="https://mift.uz/uz/menu/predstaviteli-za-rubezhom">Хорижий
														вакиллар</a></li>
												<li><a href="https://mift.uz/uz/opendata">Очиқ маълумотлар</a></li>
												<li><a href="https://mift.uz/uz/inservice">Вазирлик хизматлари</a></li>
												<li><a
														href="https://mift.uz/uz/menu/uchastie-respubliki-uzbekistan-v-sng">Ўзбекистон
														Республикасининг МДҲдаги иштироки</a></li>
												<li><a href="https://mift.uz/uz/menu/sovet-molodezhi">Ёшлар Кенгаши</a>
												</li>
												<li><a
														href="https://mift.uz/uz/menu/manavijat-va-davlat-tili-masalalari">Маънавият
														ва давлат тили масалалари</a></li>
												<li><a href="https://mift.uz/uz/costs">Вазирлик харажатлари
														моддалари</a></li>
												<li><a href="https://mift.uz/uz/menu/protivodejstvie-koruptsii">Коррупцияга
														қарши кураш</a></li>
											</ul>
										</div>
									</div>
									...
									<div class="header-menu__nav-elem">
										<div class="header-menu__nav-label"><a href=""
												class="header-menu__nav-link">Қонунчилик</a>
											<div class="header-menu__nav-toggle js-headerMenuNavToggle">
												<svg class="icon icon-down ">
													<use xlink:href="#icon-down"></use>
												</svg>
										...
										<div class="header-menu__nav-list">
											<ul class="list-unstyled">
												<li><a href="#">Ташқи
														иқтисодий ва вазирлик фаолиятининг ҳуқуқий асослари</a></li>
												<li><a href="#">Вазирликнинг
														идоравий хужжатлари</a></li>
												<li><a href="#">Инвестициявий
														бошқарув</a></li>
												<li><a href="#">Ташқи
														савдо бошқаруви</a></li>
												<li><a href="#">Транспорт
														соҳасида </a></li>
												<li><a href="#">Божхона
														ва солиқ бошқаруви</a></li>
												<li><a href="#">Хавфсизлик
														сиёсати</a></li>
												<li><a href="#">Ўз
														кучини йўқотган меъёрий-ҳуқуқий ҳужжатлар</a></li>
												<li><a href="#">Ишлаб
														чиқилаётган меъёрий-хуқуқий ҳужжатлар лойиҳалари</a></li>
											</ul>
										</div>
									</div>
								...
								<div class="header-menu__nav-col">
									<div class="header-menu__nav-elem">
										<div class="header-menu__nav-label"><a href=""
												class="header-menu__nav-link">Инвестициялар</a>
											<div class="header-menu__nav-toggle js-headerMenuNavToggle">
												<svg class="icon icon-down ">
													<use xlink:href="#icon-down"></use>
												</svg>
										...
										<div class="header-menu__nav-list">
											<ul class="list-unstyled">
												<li><a href="#">Ўзбекистон
														ҳақида</a></li>
												<li><a href="#">Инвесторлар учун қўлланма</a>
												</li>
												<li><a href="#">Инвесторлар муваффақияти
														тарихи</a></li>
												<li><a href="#">Хорижий инвесторлар
														кенгаши</a></li>
												<li><a href="#">Статистика ва
														таҳлил</a></li>
												<li><a href="#">Инвестиция
														муҳити</a></li>
											</ul>
										</div>
									</div>
									<div class="header-menu__nav-elem">
										<div class="header-menu__nav-label"><a href=""
												class="header-menu__nav-link">Ташқи савдо</a>
											<div class="header-menu__nav-toggle js-headerMenuNavToggle">
												<svg class="icon icon-down ">
													<use xlink:href="#icon-down"></use>
												</svg>
									...
									<div class="header-menu__nav-elem">
										<div class="header-menu__nav-label"><a href=""
												class="header-menu__nav-link">Матбуот хизмати</a>
											<div class="header-menu__nav-toggle js-headerMenuNavToggle">
												<svg class="icon icon-down ">
													<use xlink:href="#icon-down"></use>
												</svg>
										...
										<div class="header-menu__nav-list">
											<ul class="list-unstyled">
												...
												<li><a href="#">Аккредитация
														тартиби</a></li>
												<li><a href="#">Матбуот
														хизмати билан алоқа</a></li>
												<li><a href="#">Ахборот
														олиш учун сўровларни кўриб чиқиш тартиби</a></li>
											</ul>
										</div>
									</div>
								</div>
								<div class="header-menu__nav-col">
									...
									<div class="header-menu__nav-elem">
										<div class="header-menu__nav-label"><a href=""
												class="header-menu__nav-link">Алоқа</a>
											<div class="header-menu__nav-toggle js-headerMenuNavToggle">
												<svg class="icon icon-down ">
													<use xlink:href="#icon-down"></use>
												</svg>
									...
									<div class="header-menu__nav-elem">
										<div class="header-menu__nav-label"><a href=""
												class="header-menu__nav-link">Сайт харитаси</a>
											<div class="header-menu__nav-toggle js-headerMenuNavToggle">
												<svg class="icon icon-down ">
													<use xlink:href="#icon-down"></use>
												</svg>
				...
				<div class="header-menu-logo">
					<img src="images/logo/menu_logo1.svg" alt="logo" />
				</div>
			</div>
			<!-- header slider show start-->
			<div class="index-slider js-indexSlider">
				<div class="swiper-container" id="bx_2647108251_iblock_12">
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<div class="index-slide">
								<div style="background-image: url('https://mift.uz/uploads/news/c8a24121c3d9be96b3abbb319b693e36.JPG')"
									class="index-slide__background"></div>
								<div class="container">
									<div class="index-slide__container">
										<div class="index-slide__left">
											<div class="index-slide__title wow-slider fadeInUp"
												data-animation="fadeInUp" data-wow-delay="1s">
												ИТСВ ва «Сколково»: таълим экотизимини шакллантириб, стратегик ва амалий
												менеджмент даражасини бирлаштирамиз </div>
											<div class="index-slide__desc">
											</div>
											<div class="index-slide__button wow-slider fadeInUp"
												data-animation="fadeInUp" data-wow-delay="1.5s">
												<a href="#" class="button size_medium vi-nopart">
													<span class="button__text vi-nopart"> Батафсил <i
															class="fa fa-chevron-right"></i>
													</span>
												</a>
												<div class="index-slide-date">
													<i class="fa fa-clock-o" aria-hidden="true"></i> 14 Феврал / 19:05
												</div>
											</div>
										</div>
									</div>
						...
						<div class="swiper-slide">
							<div class="index-slide">
								<div style="background-image: url('https://mift.uz/uploads/news/a1375b44d3e5e0aeb6571cf359f6ab2f.JPG')"
									class="index-slide__background"></div>
								<div class="container">
									<div class="index-slide__container">
										<div class="index-slide__left">
											<div class="index-slide__title wow-slider fadeInUp"
												data-animation="fadeInUp" data-wow-delay="1s">
												ИТБ Ўзбекистондаги иштирокини изчил кенгайтирмоқда </div>
											<div class="index-slide__desc">
											</div>
											<div class="index-slide__button wow-slider fadeInUp"
												data-animation="fadeInUp" data-wow-delay="1.5s">
												<a href="https://mift.uz/uz/news/itb-uzbekistondagi-ishtirokini-izchil-kengajtirmoda"
													class="button style_blue_gradient size_medium vi-nopart">
													<span class="button__text vi-nopart"> Батафсил <i
															class="fa fa-chevron-right"></i>
													</span>
												</a>
												<div class="index-slide-date">
													<i class="fa fa-clock-o" aria-hidden="true"></i> 14 Феврал / 18:01
												</div>
											</div>
										</div>
									</div>
						...
						<div class="swiper-slide">
							<div class="index-slide">
								<div style="background-image: url('https://mift.uz/uploads/news/13424200e0595570fa3ef2536041c041.JPG')"
									class="index-slide__background"></div>
								<div class="container">
									<div class="index-slide__container">
										<div class="index-slide__left">
											<div class="index-slide__title wow-slider fadeInUp"
												data-animation="fadeInUp" data-wow-delay="1s">
												Ўзбекистон ва Хитой ўртасидаги ҳамкорликни кенгайтиришнинг долзарб
												вазифалари кўриб чиқилди </div>
											<div class="index-slide__desc">
											</div>
											<div class="index-slide__button wow-slider fadeInUp"
												data-animation="fadeInUp" data-wow-delay="1.5s">
												<a href="https://mift.uz/uz/news/uzbekiston-va-hitoj-urtasidagi-amkorlikni-kengajtirishning-dolzarb-vazifalari-kurib-chiildi"
													class="button style_blue_gradient size_medium vi-nopart">
													<span class="button__text vi-nopart"> Батафсил <i
															class="fa fa-chevron-right"></i>
													</span>
												...
												<div class="index-slide-date">
													<i class="fa fa-clock-o" aria-hidden="true"></i> 12 Феврал / 17:19
												</div>
											</div>
										</div>
									</div>
						...
						<div class="swiper-slide">
							<div class="index-slide">
								<div style="background-image: url('https://mift.uz/uploads/news/a23def970ae5d29b38bcd7fc3889cb96.jpg')"
									class="index-slide__background"></div>
								<div class="container">
									<div class="index-slide__container">
										<div class="index-slide__left">
											<div class="index-slide__title wow-slider fadeInUp"
												...
												ҳузуридаги Халқаро ҳамкорлик ва тараққиёт агентлигининг янги раҳбари
												тайинланди </div>
											<div class="index-slide__desc">
											</div>
											<div class="index-slide__button wow-slider fadeInUp"
												data-animation="fadeInUp" data-wow-delay="1.5s">
												<a href="https://mift.uz/uz/news/uzbekiston-respublikasi-investitsijalar-va-tashi-savdo-vazirligi-uzuridagi-halaro-amkorlik-va-taraiet-agentligining-jangi-rabari-tajinlandi"
													class="button style_blue_gradient size_medium vi-nopart">
													<span class="button__text vi-nopart"> Батафсил <i
															class="fa fa-chevron-right"></i>
													</span>
												...
												<div class="index-slide-date">
													<i class="fa fa-clock-o" aria-hidden="true"></i> 11 Феврал / 20:01
												</div>
											</div>
										</div>
									</div>
				...
				<div class="index-slider__nav">
					<div class="index-slider__nav-button js-indexSliderPrev">
						<i class="fa fa-chevron-up"></i>
					</div>
					<div class="index-slider__nav-button style_white js-indexSliderNext">
            ...
            <script src="js/amcharts/kelly.js"></script>
							...
							<div class="my-row">
								<div class="my-col-4">
									<div class="rating-b-item">
										<a href="https://sez.gov.uz/ru/organization/industrial-zone" target="_blank"
											rel="nofollow" class="rating-hover">
											<span class="rating-unity">
												<span class="rating-count" data-counter="417">417</span>
											</span>
											<span>кичик саноат зоналари</span>
								...
								<div class="my-col-4">
									<div class="rating-b-item">
										<a href="https://sez.gov.uz/ru/organization/free-economic-zone" target="_blank"
											rel="nofollow" class="rating-hover">
											<span class="rating-unity">
												<span class="rating-count" data-counter="22">22</span>
											</span>
											<span>эркин иқтисодий зоналар</span>
								...
								<div class="my-col-4">
									<div class="rating-b-item">
										<a>
											<span class="rating-unity">
												<span class="rating-count" data-counter="11.11">11.11</span>
												млрд $ </span>
											<span>2021 йилда ўзлаштирилган хорижий инвестициялар асосий капиталга
												йўналтирилган</span>
								...
								<div class="my-col-4">
									<div class="rating-b-item">
										<a>
											<span class="rating-unity">
												<span class="rating-count" data-counter="318">318</span>
											</span>
											<span>йирик ва муҳим лойиҳалар 2021 йилда амалга оширилди <br></span>
								...
								<div class="my-col-4">
									<div class="rating-b-item">
										<a>
											<span class="rating-unity">
												<span class="rating-count" data-counter="1120">1120</span>
											</span>
											<span>Инвестиция дастури доирасида амалга оширилаётган лойиҳалар</span>
								...
								<div class="my-col-4">
									<div class="rating-b-item">
										<a>
											<span class="rating-unity">
												<span class="rating-count" data-counter="42.1">42.1</span>
												млрд $ </span>
											<span>2021 йилда товар айланмаси</span>
						...
						jQuery({
							...
							step: function() {
								if (isFloat($this.data('counter'))) {
									$this.text(Number.parseFloat(this.Counter).toFixed(
										1) /*Math.ceil(this.Counter)*/ );
								} else {
			...
			<section class="news-home">
				<div class="container">
					<div class="news-home__main">
						<div class="title">
							<h2>Янгиликлар</h2>
							<div class="all-news"><a href="#"> Барча янгиликлар</a></div>
							<div class="rss"><a href="#">rss<i class="fa fa-rss" aria-hidden="true"></i></a></div>
						</div>
						<div class="main-row">
							<div class="news-item__col" data-aos="zoom-in">
								<div class="news-item">
									<a href="#">
										<div class="news-item__img">
											<img src="images/thumb/340/c8a24121c3d9be96b3abbb319b693e36.JPG" alt="" />
										</div>
										<div class="news-item__header">
											<div class="news-item__date">
												<span>14 Феврал 2022</span>
											</div>
											<div class="news-item__title">
												<h2>ИТСВ ва «Сколково»: таълим экотизимини шакллантириб, стратегик ва
													амалий менеджмент даража&hellip;</h2>
											</div>
										</div>
							...
							<div class="news-item__col" data-aos="zoom-in">
								<div class="news-item">
									<a href="#">
										<div class="news-item__img">
											<img src="images/thumb/340/a1375b44d3e5e0aeb6571cf359f6ab2f.JPG" alt="" />
										</div>
										<div class="news-item__header">
											<div class="news-item__date">
												<span>14 Феврал 2022</span>
											...
											<div class="news-item__title">
												<h2>ИТБ Ўзбекистондаги иштирокини изчил кенгайтирмоқда</h2>
											</div>
										</div>
										<div class="news-item__footer">
											<div class="news-item__readmore">
							...
							<div class="news-item__col" data-aos="zoom-in">
								<div class="news-item">
									<a href="#">
										<div class="news-item__img">
											<img src="images/uploads/news/464d62.jpg" alt="" />
										</div>
										<div class="news-item__header">
											<div class="news-item__date">
												<span>14 Феврал 2022</span>
											...
											<div class="news-item__title">
												<h2>ТАДБИРКОРЛАР УЧУН СУРОВНОМА</h2>
											</div>
										</div>
										<div class="news-item__footer">
											<div class="news-item__readmore">
							...
							<div class="news-item__col" data-aos="zoom-in">
								<div class="news-item">
									<a href="#">
										<div class="news-item__img">
											<img src="images/thumb/340/13424200e0595570fa3ef2536041c041.JPG" alt="" />
										</div>
										<div class="news-item__header">
											<div class="news-item__date">
												<span>12 Феврал 2022</span>
											</div>
											<div class="news-item__title">
												<h2>Ўзбекистон ва Хитой ўртасидаги ҳамкорликни кенгайтиришнинг долзарб
													вазифалари кўриб чиқилд&hellip;</h2>
											</div>
										</div>
										<div class="news-item__footer">
											<div class="news-item__readmore">
                ...
                <div class="container">
                    <div class="services-main">
                        <div class="title title-yellow">
                            <h2>Интерактив ҳизматлар</h2>
                            <a href="#">Барча ҳизматлар</a>
                        </div>
                        <div class="services">
                            <div class="services-item" data-aos="zoom-in-up">
                                <a href="https://mift.uz/uz/request_info">
                                    <div class="services-item__image">
                                        <img src="images/thumb/90/655bcefa19d5e34273ad66f25f962a0b.png"
                                            alt="" />
                                    </div>
                                    <div class="services-item__title item-304">
                                        <h2>Инвестициявий таклифлар паспортлари</h2>
                                    </div>
                                </a>
                            </div>
                            <div class="services-item" data-aos="zoom-in-up">
                                <a href="#">
                                    <div class="services-item__image">
                                        <img src="images/thumb/90/795fd8a8dbcafa340526086eeffcb7a4.png"
                                            alt="" />
                                    </div>
                                    <div class="services-item__title item-2230">
                                        <h2>Форс мажор</h2>
                                    </div>
                                </a>
                            </div>
                            <div class="services-item" data-aos="zoom-in-up">
                                <a href="#">
                                    <div class="services-item__image">
                                        <img src="images/thumb/90/2e8118dd53da0d3452e29b8aa8c49144.png"
                                            alt="" />
                                    </div>
                                    <div class="services-item__title item-4630">
                                        <h2>Тадбиркорга ёрдам</h2>
                                    </div>
                                </a>
                            </div>
                            <div class="services-item" data-aos="zoom-in-up">
                                <a href="#">
                                    <div class="services-item__image">
                                        <img src="images/thumb/90/43af0a497d5f7e08dee333588c60a164.png"
                                            alt="" />
                                    </div>
                                    <div class="services-item__title item-12">
                                        <h2>Тадбирлар</h2>
                                    </div>
                                </a>
                            </div>
			...
			<!-- <link href="js/mapsvg/mapsvg.css" rel="stylesheet"> -->
			<link href="js/mapsvg/nanoscroller.css" rel="stylesheet">
			...
			<section class="territorial-home">
				<div class="container">
					<div class="title">
						<h2>Ҳудудий бўлинмалар</h2>
					</div>
					<!-- <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" class="slider1" href="#slider1">Инвестиция бошқариш</a>
                        </li> -->
					<!-- <li><a data-toggle="tab" href="#slider2" class="slider-b slider2">Экспортни мувофиқлаштириш
                                штаби</a></li> -->
					</ul>
					<div class="clearfix"></div>
				</div>
				<div class="tab-content">
					<div id="slider1" class="tab-pane fade in active">

						<div class="territorial-main territorial-slider1">
							<div class="container">
								<div class="row">
									<div class="col-md-7">
										<div class="territorial">
											<div class="map">
												...
												<svg xmlns:mapsvg="http://mapsvg.com"
													...
													preserveAspectRatio="xMidYMid meet" viewBox="0 0 792.4873 516.87848"
													style="transform: scale(0.999286); fill:#94bbda;">

													<path
														style="fill: rgb(248, 252, 252); fill-opacity: 1; stroke: rgb(255, 255, 255); stroke-width: 0.64792px; stroke-opacity: 1;"
													...
													<path
														...
														title="Sarvan (Sughd Province, Tajikistan)" id="TJ-SU"
														class=" mapsvg-region"
														style=" stroke: rgb(255, 255, 255); stroke-width: 1.55501px;">
													</path>
													<path
														...
														title="Andijon" id="UZ-AN" class=" mapsvg-region"
														style=" stroke: rgb(255, 255, 255); stroke-width: 1.55501px;">
													</path>
													<path
														...
														title="Buxoro" id="UZ-BU" class=" mapsvg-region"
														style=" stroke: rgb(255, 255, 255); stroke-width: 1.55501px;">
													</path>
													<path
														...
														title="Farg‘ona" id="UZ-FA" class=" mapsvg-region"
														style=" stroke: rgb(255, 255, 255); stroke-width: 1.55501px;">
													</path>
													<path
														...
														title="Jizzax" id="UZ-JI" class=" mapsvg-region"
														style=" stroke: rgb(255, 255, 255); stroke-width: 1.55501px;">
													</path>
													<path
														...
														title="Namangan" id="UZ-NG" class=" mapsvg-region"
														style=" stroke: rgb(255, 255, 255); stroke-width: 1.55501px;">
													</path>
													<path
														...
														title="Navoiy" id="UZ-NW" class=" mapsvg-region"
														style=" stroke: rgb(255, 255, 255); stroke-width: 1.55501px;">
													</path>
													<path
														...
														title="Qashqadaryo" id="UZ-QA" class=" mapsvg-region"
														style=" stroke: rgb(255, 255, 255); stroke-width: 1.55501px;">
													</path>
													<path
														...
														title="Qoraqalpog‘iston Respublikasi" id="UZ-QR"
														class=" mapsvg-region"
														style=" stroke: rgb(255, 255, 255); stroke-width: 1.55501px;">
													</path>
													<path
														...
														title="Samarqand" id="UZ-SA" class=" mapsvg-region"
														style=" stroke: rgb(255, 255, 255); stroke-width: 1.55501px;">
													</path>
													<path
														...
														title="Sirdaryo" id="UZ-SI" class=" mapsvg-region"
														style=" stroke: rgb(255, 255, 255); stroke-width: 1.55501px;">
													</path>
													<path
														...
														title="Surxondaryo" id="UZ-SU" class=" mapsvg-region"
														style=" stroke: rgb(255, 255, 255); stroke-width: 1.55501px;">
													</path>
													<path
														...
														title="Toshkent City" id="UZ-TK" class=" mapsvg-region"
														style=" stroke: rgb(255, 255, 255); stroke-width: 1.55501px;">
													</path>
													<path
														...
														title="Toshkent" id="UZ-TO" class=" mapsvg-region"
														style=" stroke: rgb(255, 255, 255); stroke-width: 1.55501px;">
													</path>
													<path
														...
														title="Xorazm" id="UZ-XO" class=" mapsvg-region"
														style=" stroke: rgb(255, 255, 255); stroke-width: 1.55501px;">
													</path>
												</svg>
												<input type="hidden" id="map-current" value="UZ-TK" />
												<style>
												.territorial-slider1 #UZ-TK {
													display: block;
												}

												.territorial-slider1 .mapsvg-marker {
													display: none;
												}
												</style>
												<div id="mapsvg"></div>
												...
												jQuery(document).ready(function() {
													...
													maps_slider.owlCarousel({
														...
														var src = $(event.target).find(".owl-item")
															.eq(current).find(".item").data('map');
														var mapcurrent = $('#map-current').val();
														$('#' + mapcurrent).css('display', 'block');
													...
													jQuery("#mapsvg").mapSvg({
														...
														viewBox: [-0.283223137254879, 0,
															793.0537462745098, 516.87848
														],
														cursor: "pointer",
														// selected:false,
														zoom: {
														...
														onClick: function(e, mapsvg) {
															...
															var item_id = $('.item_' + this.id)
																.val();

															// console.log(item_id);

															maps_slider.trigger(
																'to.owl.carousel', item_id,
																300);
														...
														source: "https://mift.uz/assets/public/mapsvg/uzbekistan.svg",
														title: "Uzbekistan",
														loadingText: "",
														markers: [{
																id: "UZ-TK",
																...
																isLink: false,
																data: {},
																src: "https://mift.uz/assets/public/images/map-marker2.png",
																width: 27,
																height: 37,
																geoCoords: [41.308919,
																	69.302772
									...
									<input type="hidden" class="item_UZ-TK" value="0" />

									<input type="hidden" class="item_UZ-TO" value="1" />

									<input type="hidden" class="item_UZ-XO" value="2" />

									<input type="hidden" class="item_UZ-FA" value="3" />

									<input type="hidden" class="item_UZ-SI" value="4" />

									<input type="hidden" class="item_UZ-SU" value="5" />

									<input type="hidden" class="item_UZ-SA" value="6" />

									<input type="hidden" class="item_UZ-NG" value="7" />

									<input type="hidden" class="item_UZ-NW" value="8" />

									<input type="hidden" class="item_UZ-QA" value="9" />

									<input type="hidden" class="item_UZ-JI" value="10" />

									<input type="hidden" class="item_UZ-BU" value="11" />

									<input type="hidden" class="item_UZ-AN" value="12" />

									<input type="hidden" class="item_UZ-QR" value="13" />

									<div class="col-md-5">
										<div class="map-slider-bg">
											<div id="map-slider" class="owl-carousel owl-theme">
												<div class="item" data-map="UZ-TK">
													...
													<div class="map-item">
														...
														<div class="map-content">
															<ul class="list-unstyled">
																<li>
																	<h5>Рахманов Шароф Диёрович</h5>
																</li>
																<li>
																	<p><span>Электрон почта:</span></p>
																	<p> <a href="#">tashkentcity@mift.uz</a>
																	</p>
																</li>
																<li>
												...
												<div class="item" data-map="UZ-TO">
													...
													<div class="map-item">
														<div class="map-title">
															<h4>Тошкент вилояти </h4>
														</div>
														<div class="map-content">
															<ul class="list-unstyled">
																<li>
																	<h5>Шарипов Нажмиддинхўжа Шухратович</h5>
																</li>
																<li>
																	<p><span>Электрон почта:</span></p>
																	<p> <a href="#">tashkent@mift.uz</a>
																	</p>
																</li>
																<li>
																	<p><span>Телефон:</span> </p>
												...
												<div class="item" data-map="UZ-XO">
													...
													<div class="map-item">
														<div class="map-title">
															<h4>Хоразм вилояти </h4>
														</div>
														<div class="map-content">
															<ul class="list-unstyled">
																<li>
																	<h5>Туляганов Шавкат Абиджанович</h5>
																</li>
																<li>
																	<p><span>Электрон почта:</span></p>
																	<p> <a href="#">khorezm@mift.uz</a>
																	</p>
																</li>
																<li>
																	<p><span>Телефон:</span> </p>
												...
												<div class="item" data-map="UZ-FA">
													...
													<div class="map-item">
														<div class="map-title">
															<h4>Фарғона вилояти </h4>
														</div>
														<div class="map-content">
															<ul class="list-unstyled">
																<li>
																	<h5>Эргашев Иқболжон Одилжонович</h5>
																</li>
																<li>
																	<p><span>Электрон почта:</span></p>
																	<p> <a href="#">fergana@mift.uz</a>
																	</p>
																</li>
																<li>
																	<p><span>Телефон:</span> </p>
												...
												<div class="item" data-map="UZ-SI">
													...
													<div class="map-item">
														<div class="map-title">
															<h4>Сирдарё вилояти </h4>
														</div>
														<div class="map-content">
															<ul class="list-unstyled">
																<li>
																	<h5>Мадиримов Данияр Маматсалиевич</h5>
																</li>
																<li>
																	<p><span>Электрон почта:</span></p>
																	<p> <a href="#">sirdaryo@mift.uz</a>
																	</p>
																</li>
																<li>
																	<p><span>Телефон:</span> </p>
												...
												<div class="item" data-map="UZ-SU">
													...
													<div class="map-item">
														<div class="map-title">
															<h4>Сурхондарё вилояти </h4>
														</div>
														<div class="map-content">
															<ul class="list-unstyled">
																<li>
																	<h5>Орипов Анвар Хомитович</h5>
																</li>
																<li>
																	<p><span>Электрон почта:</span></p>
																	<p> <a href="#">surkhandaryo@mift.uz</a>
																	</p>
																</li>
																<li>
																	<p><span>Телефон:</span> </p>
												...
												<div class="item" data-map="UZ-SA">
													...
													<div class="map-item">
														<div class="map-title">
															<h4>Самарқанд вилояти </h4>
														</div>
														<div class="map-content">
															<ul class="list-unstyled">
																<li>
																	<h5>Ходжаев Ойбек Эркинович</h5>
																</li>
																<li>
																	<p><span>Электрон почта:</span></p>
																	<p> <a href="#">samarkand@mift.uz</a>
																	</p>
																</li>
																<li>
																	<p><span>Телефон:</span> </p>
												...
												<div class="item" data-map="UZ-NG">
													...
													<div class="map-item">
														<div class="map-title">
															<h4>Наманган вилояти </h4>
														</div>
														<div class="map-content">
															<ul class="list-unstyled">
																<li>
																	<h5>Имамов Окибжон Одилович</h5>
																</li>
																<li>
																	<p><span>Электрон почта:</span></p>
																	<p> <a href="#">namangan@mift.uz</a>
																	</p>
																</li>
																<li>
																	<p><span>Телефон:</span> </p>
												...
												<div class="item" data-map="UZ-NW">
													...
													<div class="map-item">
														<div class="map-title">
															<h4>Навоий вилояти </h4>
														</div>
														<div class="map-content">
															<ul class="list-unstyled">
																<li>
																	<h5>Хасанов Камолиддин Абдуразакович</h5>
																</li>
																<li>
																	<p><span>Электрон почта:</span></p>
																	<p> <a href="#">navoi@mift.uz</a>
																	</p>
																</li>
																<li>
																	<p><span>Телефон:</span> </p>
												...
												<div class="item" data-map="UZ-QA">
													...
													<div class="map-item">
														<div class="map-title">
															<h4>Қашқадарё вилояти </h4>
														</div>
														<div class="map-content">
															<ul class="list-unstyled">
																<li>
																	<h5>Юсупов Бахром Музафарович</h5>
																</li>
																<li>
																	<p><span>Электрон почта:</span></p>
																	<p> <a href="#">kashkadaryo@mift.uz</a>
																	</p>
																</li>
																<li>
																	<p><span>Телефон:</span> </p>
												...
												<div class="item" data-map="UZ-JI">
													...
													<div class="map-item">
														<div class="map-title">
															<h4>Жиззах вилояти </h4>
														</div>
														<div class="map-content">
															<ul class="list-unstyled">
																<li>
																	<h5>Нурматов Нодир Баҳодирович</h5>
																</li>
																<li>
																	<p><span>Электрон почта:</span></p>
																	<p> <a href="#">djizzakh@mift.uz</a>
																	</p>
																</li>
																<li>
																	<p><span>Телефон:</span> </p>
												...
												<div class="item" data-map="UZ-BU">
													...
													<div class="map-item">
														<div class="map-title">
															<h4>Бухоро вилояти </h4>
														</div>
														<div class="map-content">
															<ul class="list-unstyled">
																<li>
																	<h5>Асадов Ризо Раупович</h5>
																</li>
																<li>
																	<p><span>Электрон почта:</span></p>
																	<p> <a href="#">bukhara@mift.uz</a>
																	</p>
																</li>
																<li>
																	<p><span>Телефон:</span> </p>
												...
												<div class="item" data-map="UZ-AN">
													...
													<div class="map-item">
														...
														<div class="map-content">
															<ul class="list-unstyled">
																<li>
																	<h5>Хамроев Ботир Бахромжонович</h5>
																</li>
																<li>
																	<p><span>Электрон почта:</span></p>
																	<p> <a href="#">andijan@mift.uz</a>
																	</p>
																</li>
																<li>
																	<p><span>Телефон:</span> </p>
												...
												<div class="item" data-map="UZ-QR">
													...
													<div class="map-item">
														<div class="map-title">
															<h4><a href="#" target="_blank">Қорақалпоғистон Республикаси
																	инвестициялар ва ташқи савдо вазирлиги</a></h4>
														</div>
														<div class="map-content">
															<ul class="list-unstyled">
																<li>
																	<h5><a href="#" target="_blank">Хабибуллаев Бахытжан
																			Сагидуллаевич</a></h5>
																</li>
																<li>
																	<p><span>Электрон почта:</span></p>
																	<p> <a href="#">miftrk@miftrk.uz</a>
																	</p>
																</li>
																<li>
																	<p><span>Телефон:</span> </p>
																	<p><a href="#">+99861 222-60-91</a>
																	</p>
					...
					<div id="slider2" class="tab-pane fade">
					</div>
					<input type="hidden" value="send" id="slider-ajax" />
					<script>
					jQuery(document).ready(function() {
						jQuery('.slider2').click(function() {
							var status_slider = $('#slider-ajax').val();
							//console.log(status_slider);
							if (status_slider == 'send') {
								jQuery.ajax({
									type: 'post',
									url: "#",
									success: function(data) {
										var status_slider = $('#slider-ajax').val(
											'no-send');;
										jQuery('#slider2').html(data);
									},
									error: function(data) {}
								});
								// 'https://mift.uz/uz/ajax/territorial/slider2'
							}
						});
					});
					</script>
			...
			<section class="useful-links__home">
				<div class="container">
					<div class="useful-links__main">
						<div class="title title-yellow">
							<h2>Фойдали хаволалар</h2>
						</div>
						<div class="useful-links">
							<div id="owl-useful" class="owl-carousel owl-theme">
								<div class="item">
									<div class="useful-item">
										<a href="http://privatization.davaktiv.uz" target="_blank">
											<div class="useful-item__img">

												<img src="images/thumb/100/default.png" alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">Оммавий савдолар орқали сотилиши ва ижарага
													берилишини белгиланган давлат активлари</span>
												<h2 class="vi-nopart">privatization.davaktiv.uz</h2>
											</div>
										</a>
									</div>
								</div>
								<div class="item">
									<div class="useful-item">
										<a href="http://invest.gov.uz" target="_blank">
											<div class="useful-item__img">

												<img src="images/thumb/100//1772447ee5ecf8367b1d24383ae5f805.png"
													alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">Чет эл инвестицияларини жалб қилиш
													Агентлиги</span>
												<h2 class="vi-nopart">invest.gov.uz</h2>
											</div>
										</a>
									</div>
								</div>
								<div class="item">
									<div class="useful-item">
										<a href="http://aoka.uz" target="_blank">
											<div class="useful-item__img">

												<img src="images/thumb/100/e0e73c0db8198b68d5947854cdcf8749.png"
													alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">Ўзбекистон Республикаси Президенти
													Администрацияси ҳузуридаги Ахборот ва оммавий коммуникациялар
													агентлиги</span>
												<h2 class="vi-nopart">aoka.uz</h2>
											</div>
										</a>
									</div>
								</div>
								<div class="item">
									<div class="useful-item">
										<a href="http://stat.uz" target="_blank">
											<div class="useful-item__img">

												<img src="images/thumb/100/d6142fda42f7321087e82370f4d763a6.jpg"
													alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">Ўзбекистон Республикаси давлат статистика
													қўмитаси</span>
												<h2 class="vi-nopart">stat.uz</h2>
											</div>
										</a>
									</div>
								</div>
									...
									<div class="useful-item">
										<a href="http://www.lex.uz" target="_blank">
											<div class="useful-item__img">
												...
												<img src="images/thumb/100/2f22eb0afcda658cf4cbda396f493c0e.png"
													alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">Ўзбекистон Республикаси Қонун ҳужжатлари
													маълумотлари миллий базаси</span>
												<h2 class="vi-nopart">www.lex.uz</h2>
											</div>
										</a>
									</div>
								</div>
								<div class="item">
									<div class="useful-item">
										<a href="http://www.huquqiyportal.uz" target="_blank">
											<div class="useful-item__img">

												<img src="images/thumb/100/cef169c026371e914ce0ab3fbd014e2c.png"
													alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">Ўзбекистон Республикаси Миллий ҳуқуқий интернет
													портали</span>
												<h2 class="vi-nopart">www.huquqiyportal.uz</h2>
											</div>
										</a>
									</div>
								</div>
								<div class="item">
									<div class="useful-item">
										<a href="http://president.uz" target="_blank">
											<div class="useful-item__img">

												<img src="images/thumb/008ad2001caa0bfb6c9c01a3a69d2d2e.png" alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">Ўзбекистон Республикаси Президентининг расмий
													веб-сайти</span>
												<h2 class="vi-nopart">president.uz</h2>
											</div>
										</a>
									</div>
								</div>
									...
									<div class="useful-item">
										<a href="http://parliament.gov.uz" target="_blank">
											<div class="useful-item__img">
												...
												<img src="images/thumb/100/06ed88904605c071be57758f03b52e48.jpg"
													alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">Ўзбекистон Республикаси Олий Мажлиси Қонунчилик
													палатаси</span>
												<h2 class="vi-nopart">parliament.gov.uz</h2>
											</div>
										</a>
									</div>
								</div>
									...
									<div class="useful-item">
										<a href="http://data.gov.uz" target="_blank">
											<div class="useful-item__img">
												...
												<img src="images/thumb/100/52065cf0e9c20ac841bb7df273f4ef11.jpg"
													alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">Ўзбекистон Республикаси очиқ маълумотлар
													портали</span>
												<h2 class="vi-nopart">data.gov.uz</h2>
											</div>
										</a>
									</div>
								</div>
									...
									<div class="useful-item">
										<a href="http://senat.uz" target="_blank">
											<div class="useful-item__img">
												...
												<img src="images/thumb/100/1c51dcd238eb131d1ac77417a5f03da1.png"
													alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">Ўзбекистон Республикаси Олий Мажлиси
													Сенати</span>
												<h2 class="vi-nopart">senat.uz</h2>
											</div>
										</a>
									</div>
								</div>
								<div class="item">
									<div class="useful-item">
										<a href="http://davaktiv.uz" target="_blank">
											<div class="useful-item__img">

												<img src="images/thumb/100/5f4663dadbdb87941067b5a045fe965c.png"
													alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">Ўзбекистон Республикаси Давлат активларини
													бошқариш агентлиги</span>
												<h2 class="vi-nopart">davaktiv.uz</h2>
											</div>
										</a>
									</div>
								</div>
								<div class="item">
									<div class="useful-item">
										<a href="http://www.napm.uz" target="_blank">
											<div class="useful-item__img">

												<img src="images/thumb/100/86905973a8c6d267b8f407300927799a.png"
													alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">O`zbekiston Respublikasi Prezidenti huzuridagi
													Loyiha boshqaruvi milliy agentligi</span>
												<h2 class="vi-nopart">www.napm.uz</h2>
											</div>
										</a>
									</div>
								</div>
								<div class="item">
									<div class="useful-item">
										<a href="http://www.mitc.uz" target="_blank">
											<div class="useful-item__img">

												<img src="images/thumb/100/8433a9c9095a82db8b6b11d3ce9ac739.png"
													alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">Министерство по развитию информационных
													технологий и коммуникаций Республики Узбекистан</span>
												<h2 class="vi-nopart">www.mitc.uz</h2>
											</div>
										</a>
									</div>
								</div>
								<div class="item">
									<div class="useful-item">
										<a href="http://www.strategy.gov.uz" target="_blank">
											<div class="useful-item__img">

												<img src="images/thumb/100/fdbffcebbe69d7f5102274a7af93d67c.png"
													alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">2017-2021 yillarda O‘zbekiston Respublikasini
													rivojlantirishning beshta ustuvor yo‘nalishi bo‘yicha harakatlar
													strategiyasi</span>
												<h2 class="vi-nopart">www.strategy.gov.uz</h2>
											</div>
										</a>
									</div>
								</div>
								<div class="item">
									<div class="useful-item">
										<a href="http://www.gov.uz" target="_blank">
											<div class="useful-item__img">

												<img src="images/thumb/100/b3ad09dbebbe4c84bb44427178476f90.png"
													alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">Портал Государственной Власти Республики
													Узбекистан</span>
												<h2 class="vi-nopart">www.gov.uz</h2>
											</div>
										</a>
									</div>
								</div>
									...
									<div class="useful-item">
										<a href="http://www.press-service.uz" target="_blank">
											<div class="useful-item__img">
												...
												<img src="images/thumb/100/b1b434184228e4a06289fd17de5c0067.png"
													alt="" />
											</div>
											<div class="useful-item__content vi-nopart">
												<span class="vi-nopart">Официальный веб-сайт Президента Республики
													Узбекистан</span>
												<h2 class="vi-nopart">www.press-service.uz</h2>
											</div>
										</a>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-5">
								<div class="footer-bottom__left">
									<h4>Ушбу сайтда чоп этилган материаллардан фойдаланилганда www.mift.uz хаволасини
										кўрсатиб ўтиш шарт</h4>
									<div class="clearfix"></div>
								</div>
							...
							<div class="col-md-4">
								<div class="copy">
									&copy; 2022. &nbsp; Барча хуқуқлар химояланган.
								</div>
							</div>
							<div class="col-md-3">
								<!-- <div class="counter">
                                    ...
                                    <SCRIPT language="javascript" type="text/javascript">
                                        ...
                                        top_js = "1.0";
                                        top_r = "id=43470&r=" + escape(document.referrer) + "&pg=" + escape(window
                                            .location.href);
                                    ...
                                    <SCRIPT language="javascript1.2" type="text/javascript">
                                        ...
                                        top_r += "&wh=" + screen.width + 'x' + screen.height + "&px=" +
                                            (((navigator.appName.substring(0, 3) == "Mic")) ? screen.colorDepth : screen
                                                .pixelDepth)
                                    ...
                                    <SCRIPT language="JavaScript" type="text/javascript">
                                        ...
                                        top_rat = "&col=043a84&t=ffffff&p=DD444E";
                                        top_r += "&js=" + top_js + "";
                                        document.write(
                                            '<a href="http://www.uz/ru/res/visitor/index?id=43470" target=_top><img src="https://cnt0.www.uz/counter/collect?' +
                                            top_r + top_rat +
                                            '" width=88 height=31 border=0 alt="Топ рейтинг www.uz"></a>') //

                                    </SCRIPT><NOSCRIPT><A href="http://www.uz/ru/res/visitor/index?id=43470"
                                            target=_top><IMG height=31
                                                src="https://cnt0.www.uz/counter/collect?id=43470&pg=http%3A//uzinfocom.uz&&col=043a84&amp;t=ffffff&amp;p=DD444E"
			...
			<div class="modal fade" id="volume" tabindex="-1" role="dialog" aria-labelledby="smallModalLabel"
				aria-hidden="true">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="box-content" style="text-align: center;">
								Сайтда овозли ўқиш имконияти мавжуд, Матнни овозли эшитиш учун матинни белгиланг ва
								пайдо болган тугмани устига босинг </div>
						</div>
					</div>
				</div>
			</div>
			<!-- <span style="" id="gs_tooltip_title"><span class="the-tooltip top left dark-midnight-blue"><span
                        class="tooltip_inner">Белгиланган матнни тинглаш учун қуйидаги тугмани
                        босинг</span></span></span> -->
			<span style="position: absolute; margin-top: -50000px;" id="gs_tooltip"><span
					class="the-tooltip bottom left dark-midnight-blue"><span
						class="tooltip_inner powered_by_3 powered_by">Powered by <a
							href="http://2glux.com/projects/gspeech" target="_top"
							class="backlink_a">GSpeech</a></span></span></span>
			<div id="sound_container" class="sound_div sound_div_basic size_1 speaker_32">
				<div id="sound_text"></div>
			</div>
			<div id="sound_audio"></div>
			<!-- <script src="//code-eu1.jivosite.com/widget/ktGbfAHKDV" async></script> -->
			<script src="js/gs/gs.js"></script>

			<script type="text/javascript" src="js/gs/color.js"></script>
			<script type="text/javascript" src="js/gs/jQueryRotate.2.1.js"></script>
			<script type="text/javascript" src="js/gs/easing.js"></script>
			<script type="text/javascript" src="js/gs/mediaelement-and-player.min.js">
			</script>
			<script type="text/javascript" src="js/gs/gspeech.js"></script>
			<script type="text/javascript" src="js/gs/gspeech_pro.js"></script>

			<script async src="https://www.googletagmanager.com/gtag/js?id=UA-41510270-17"></script>
			<script>
			window.dataLayer = window.dataLayer || [];
			...
			<noscript>
				<div><img src="https://mc.yandex.ru/watch/56478652" style="position:absolute; left:-9999px;" alt="" />
				</div>
			</noscript>
			<!-- /Yandex.Metrika counter -->
			...
			<script src="js/spec/specialview.js"></script>
			...
			<script type="text/javascript" src="js/menu/jquery.smartmenus.bootstrap.js?v=0.4"></script>
			<script type="text/javascript" src="js/send/jquery.textmistake.js">
			</script>
			<!-- <script src="js/menu/jquery.mmenu.js"></script> -->
			...
			<script src="https://mift.uz/assets/public/js/swiper.js"></script>
			<script src="https://mift.uz/assets/public/js/custom.js?v=1644913263"></script>
			<script src="https://mift.uz/assets/public/stacktable/stacktable.min.js"></script>
			<script>
			AOS.init();
			SpecialView.run();
			$(document).ready(function() {
			...
			jQuery('#refresh_captcha_contacts').click(function() {
				jQuery.ajax({
					type: 'post',
					url: 'https://mift.uz/uz/u/action/generate_captcha',
					success: function(data) {
